with open('3_1_input','w') as f:
  f.write('CONNECT classroom.cs.unc.edu 9500\n')
...
with open('3_1_output_client','w') as f:
  f.write('CONNECT classroom.cs.unc.edu 9500\n')
  f.write('CONNECT accepted for FTP server at host classroom.cs.unc.edu and port 9500\n')
  ...
  f.write('PORT 152,2,130,35,31,64\r\n')
  f.write('FTP reply 200 accepted. Text is: Port command successful (152.2.130.35,8000).\n')
...
with open('3_1_output_server','w') as f:
  ...
  f.write('PORT 152,2,130,35,31,64\r\n')
  f.write('200 Port command successful (152.2.130.35,8000).\r\n')
  f.write('RETR existing_file\r\n')
